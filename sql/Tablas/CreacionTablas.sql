...
CREATE TABLE CATEGORIA (
    ...
    nombre_cat VARCHAR(50) NOT NULL -- Tipos de mods
);

CREATE TABLE VIDEOJUEGO (
    id_videojuego INT PRIMARY KEY AUTO_INCREMENT,
    nombre_juego VARCHAR(100) NOT NULL,
    genero VARCHAR(50) NOT NULL,      -- Para buscar por género
    plataforma VARCHAR(50) NOT NULL   -- Para buscar por plataforma
);
...
CREATE TABLE RECURSO (
    ...
    fecha_subida DATE DEFAULT (CURRENT_DATE), -- Se registra sola al crear
...
CREATE TABLE DESCARGA (
    ...
    id_usuario INT, -- Puede ser NULL si no obligas a login para bajar
